import { View, Text, StyleSheet, Image, TouchableOpacity, imgStyle } from 'react-native'
...
const postFooterIcons = [
    {
        ...
        likedImageUrl: 'https://img.icons8.com/material-rounded/256/hearts.png',
    },
    {
        name: 'Comment',
...
const Post = ({ post }) => {
    return (
        <View style={{ marginBottom: 30 }}>
            ...
            <PostImage post={post} />
            <View>
                <PostFooter style={{ marginHorizontal: 15, marginTop: 10 }} />
                <Likes post={post} />
                <Caption post={post} />
